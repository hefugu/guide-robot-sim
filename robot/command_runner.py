...
def build_config(args: argparse.Namespace) -> RobotConfig:
    return RobotConfig(
        ...
        servo_center_value=args.servo_center,
        servo_left_value=args.servo_left,
        servo_right_value=args.servo_right,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Run only first N commands. Useful for safe testing. 0 means setup only.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="Servo center value for gpiozero Servo, usually 0.0",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.85,
        help="Servo left value for gpiozero Servo, -1.0 to 1.0",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=-0.85,
        help="Servo right value for gpiozero Servo, -1.0 to 1.0",
    )
